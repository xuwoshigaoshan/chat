...
// let commonPreUrl="http://172.16.78.41:8888";
let commonPreUrl="";
//获取当地时间返回“2020年09月01日   17:13”
function getLocalDate(){
	...
	var minimum=datetime.getMinutes();
	var second=datetime.getSeconds();
	return year+"年"+month+"月"+date+"日	"+houre+":"+(minimum>9?minimum:"0"+minimum)+":"+(second>9?second:"0"+second);
}

//获取当地时间返回“2020年09月01日   17:13”
function getLocalYMDHMSM(){
	var datetime = new Date();
	var year = datetime.getFullYear();
	var month = datetime.getMonth() + 1 < 10 ? "0" + (datetime.getMonth() + 1) : datetime.getMonth() + 1;
	var date = datetime.getDate() < 10 ? "0" + datetime.getDate() : datetime.getDate();
	...
	var minimum=datetime.getMinutes();
	var second=datetime.getSeconds();
	var misll=datetime.getMilliseconds();
	return year+month+date+" "+(houre>9?houre:"0"+houre)+":"+(minimum>9?minimum:"0"+minimum)+":"+(second>9?second:"0"+second)+":"+misll;
}
//获取当地时间返回“2020年09月01日   17:13”
function getLocalHMS(){
	...
	var second=datetime.getSeconds();
	var misll=datetime.getMilliseconds();
	return houre+":"+(minimum>9?minimum:"0"+minimum)+":"+(second>9?second:"0"+second);
}
//获取当地时间返回“2020年09月01日   17:13”
function getLocaleTimeString(){
	var date = new Date();
	return date .toLocaleTimeString(); //获取当前时间
}
